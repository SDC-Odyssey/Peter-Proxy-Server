...
app.get('/pricing/:room_id', async (req, res) => {
  try {
    const roomId = req.params.room_id;
    const pricingResponseObject = await axios.get(`${localhost}:3003/pricing/${roomId}`);
...
app.get('/availability/:room_id', async (req, res) => {
  try {
    const roomId = req.params.room_id;
    const availabilityResponseObject = await axios.get(`${localhost}:3003/availability/${roomId}`);
...
app.get('/rooms', async (req, res) => {
  try {
    const response = await axios.get(`${localhost}:3002/rooms`);
...
app.get('/rooms/:roomId', async (req, res) => {
  try {
    ...
    const response = await axios.get(`${localhost}:3002/rooms/${roomId}`);
    const responseString = JSON.stringify(response.data);
    res.status(200);
    res.send(responseString);
    res.end();
...
app.get('/rooms/:roomId/title', async (req, res) => {
  try {
    const { roomId } = req.params;
    const response = await axios.get(`${localhost}:3002/rooms/${roomId}/title`);
    const responseString = JSON.stringify(response.data);
...
app.get('/rooms/:roomId/overview', async (req, res) => {
  try {
    const { roomId } = req.params;
    const response = await axios.get(`${localhost}:3002/rooms/${roomId}/overview`);
    const responseString = JSON.stringify(response.data);
...
app.get('/rooms/:roomId/highlights', async (req, res) => {
  try {
    const { roomId } = req.params;
    const response = await axios.get(`${localhost}:3002/rooms/${roomId}/highlights`);
    const responseString = JSON.stringify(response.data);
...
app.get('/rooms/:roomId/description', async (req, res) => {
  try {
    const { roomId } = req.params;
    const response = await axios.get(`${localhost}:3002/rooms/${roomId}/description`);
    const responseString = JSON.stringify(response.data);
...
app.get('/rooms/:roomId/sleeping-arranges', async (req, res) => {
  try {
    const { roomId } = req.params;
    const response = await axios.get(`${localhost}:3002/rooms/${roomId}/sleeping-arranges`);
    const responseString = JSON.stringify(response.data);
