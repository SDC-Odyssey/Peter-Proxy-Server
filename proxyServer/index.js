...
//   try {
//     const images = await axios.get(`${amandaAWS}/images`);
//     res.status(200);
//     res.send(images);
//     res.end();
//   } catch {
...
//     const images = await axios.get(`${amandaAWS}/images/${roomId}`);
//     console.log(images);
//     res.status(200);
//     res.send(images);
//     res.end();
...
app.get('/availability/:id', async (req, res) => {
  try {
    ...
    const availabilityResponseObject = await axios.get(`${proxyAWS}/availability/${id}`);
